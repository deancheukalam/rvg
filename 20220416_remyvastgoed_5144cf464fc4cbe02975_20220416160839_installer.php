...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20220416_remyvastgoed_5144cf464fc4cbe02975_20220416160839_archive.zip';
    const ARCHIVE_SIZE       = '173121347';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = '5144cf4-16160839';
    const SECONDARY_PACKAGE_HASH = '30b3113-16160839';
    const VERSION            = '4.0.5';
