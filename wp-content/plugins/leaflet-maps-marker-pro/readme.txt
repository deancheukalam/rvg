...
== Upgrade Notice ==
= 3.1 =
No manual actions needed for updating to this version. If you experience any issues, please [open a support ticket](https://www.mapsmarker.com/helpdesk).

== Changelog ==
= 3.1 =
optimized performance for Google basemaps and more - see [https://www.mapsmarker.com/v3.1p](https://www.mapsmarker.com/v3.1p) for more details
