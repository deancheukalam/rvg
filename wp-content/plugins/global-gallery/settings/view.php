...
<div class="wrap lcwp_settings_wrap" style="direction: LTR; overflow-x: hidden;">  
    ...
    <h2 class="gg_page_title"><?php _e('Global Gallery Settings', $ml_key) ?></h2>  
    
	<?php
    $engine = new gg_settings_engine('gg_settings', $GLOBALS['gg_settings_tabs'], $GLOBALS['gg_settings_structure']);
...
<link rel="stylesheet" href="<?php echo GG_URL; ?>/js/codemirror/codemirror.css">
<script src="<?php echo GG_URL; ?>/js/codemirror/codemirror.min.js" type="text/javascript"></script>
<script src="<?php echo GG_URL; ?>/js/codemirror/languages/css.min.js" type="text/javascript"></script>
