			...
			<div class="wpsm_panel wpsm_panel-default">
				<div class="wpsm_panel-heading wpsm-heading-class" role="tab" >
				  <h4 class="wpsm_panel-title">
					<a  class="<?php if($i!=1){ echo "collapsed"; } ?>"  data-toggle="collapse" data-parent="<?php if($settings['accordion_toggle_collapse']!="yes") { ?>#wpsm_accordion_<?php echo $post_id; ?> <?php } ?>" href="javascript:void(0)" data-target="#ac_<?php echo $post_id; ?>_collapse<?php echo $i; ?>"  >
