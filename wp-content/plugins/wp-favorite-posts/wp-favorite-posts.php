...
function wpfp_link_html($post_id, $opt, $action) {
	if($action == 'add'){
		$link = "<a class='wpfp-link' href='?wpfpaction=".$action."&amp;postid=". esc_attr($post_id) . "' title='". $opt ."' rel='nofollow'><img src='". WPFP_PATH . "/img/bookmark.png' alt='Bewaren' title='Bewaren' class='wpfp-img normal' /></a>";
		$link = apply_filters( 'wpfp_link_html', $link );
		return $link;
	}elseif($action == 'remove'){
		$link = "<a class='wpfp-link' href='?wpfpaction=".$action."&amp;postid=". esc_attr($post_id) . "' title='". $opt ."' rel='nofollow'><img src='". WPFP_PATH . "/img/bookmark_liked.png' alt='Je hebt dit object bewaard. Klik hier om dit object niet langer te bewaren.' title='Je hebt dit object bewaard. Klik hier om dit object niet langer te bewaren.' class='wpfp-img liked' /></a>";
    $link = apply_filters( 'wpfp_link_html', $link );
    return $link;
	}else{
...
function wpfp_loading_img() {
    return "<img src='".WPFP_PATH."/img/loading.gif' alt='Laden' title='Laden' class='wpfp-hide wpfp-img' />";
}
...
function wpfp_before_link_img() {
    ...
    if ($option == '') {
        ...
        return "<img src='" . $options['custom_before_image'] . "' alt='Favorite' title='Favorite' class='wpfp-img' /><img src='" . $options['custom_before_image'] . "' alt='Favorite' title='Favorite' class='wpfp-img' />";
    } else {
        return "<img src='". WPFP_PATH . "/img/" . $option . "' alt='Favorite' title='Favorite' class='wpfp-img normal' /><img src='". WPFP_PATH . "/img/bookmark_liked.png' alt='Favorite' title='Favorite' class='wpfp-img liked' />";
    }
}
...
//        echo wpfp_loading_img();
        echo "<a class='wpfp-link verwijder' href='?wpfpaction=clear' rel='nofollow'>". wpfp_get_option('clear') . "</a>";
    }
}
