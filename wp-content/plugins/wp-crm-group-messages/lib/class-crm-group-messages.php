...
class class_crm_group_messages {
  ...
  static function display_newsletter_ui($filters = '') {
    ...
    <div class="wp_crm_newsletter_ui">
      ...
      <script type="text/javascript">
        jQuery(document).ready(function () {
          ...
          jQuery(".wpc_no_email_roles").live("change", function () {
          ...
          jQuery(".message_template", wpc_n_form).live("change", function () {
          ...
          jQuery(".send_message", wpc_n_form).live("click", function () {
    ...
    <?php } ?>
          ...
          jQuery(".discard_message", wpc_n_form).live("click", function () {
    ...
    <?php if ( isset($no_emails) ) { ?>
            <li class="wpc_section_wrapper wp_crm_no_email_handling">
                ...
                <?php echo sprintf(__('Be advised, %1d of the %2d intended recipients do not have an e-mail addresses.  <span class="wp_crm_secondary_action wp_crm_toggle" toggle="wp_crm_no_email_actions">Take action.</span>', ud_get_wp_crm_group_messages()->domain), count($no_emails), count($users)); ?>
