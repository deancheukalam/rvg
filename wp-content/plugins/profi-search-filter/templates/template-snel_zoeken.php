...
if (in_array("Thumbnail", $fields)) {
    foreach ($custom_fields['Thumbnail'] as $thumb) {
        echo '<a href="' . get_permalink() . '" target=""><img src="' . $thumb . '" class="object_img img-responsive" /></a>';
    }
}
?>
...
<div class="object_inner">
    ...
    if (in_array("Prijs", $fields)) {
        foreach ($custom_fields['Prijs'] as $prijs) {
            if ($prijs == 'n.o.t.k.' || strpos($prijs, 'vanaf') !== false || strpos($prijs, 'v.a.') !== false || strpos($prijs, 'tot') !== false || strpos($prijs, 'Verhuurd') !== false || strpos($prijs, 'on hold') !== false || strpos($prijs, 't.e.a.b.') !== false || strpos($prijs, '$') !== false || strpos($prijs, 'Verkocht ov') !== false || $prijs == 'notk') {
...
<div class="object_footer">
    <a href="<?php echo get_permalink(); ?>" target=""><img src="<?php bloginfo('template_url'); ?>/images/marker_icon.png" class="marker_icon" />
