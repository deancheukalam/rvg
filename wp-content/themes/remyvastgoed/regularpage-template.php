        ...
        <!-- <div class="stick"> -->
            ...
            <div class="banner">
                <a href="#">
                    ...
                    <?php echo site_url(); ?>/wp-content/themes/remyvastgoed/images/rbc_banner.jpg
                </a>
            </div>

            <div class="banner">
                <a href="#">
                    <img src="wp-content/themes/remyvastgoed/images/lont.jpg" />
                </a>
            </div>

            <div class="banner">
                <a href="#">
                    <img src="wp-content/themes/remyvastgoed/images/banner_geldleningen.png" />
                </a>
            </div>
