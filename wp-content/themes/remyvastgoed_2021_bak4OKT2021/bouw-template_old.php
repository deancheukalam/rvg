...
<div class="stick">
    <div id="contact">
        <h2>Contact</h2>
        <br>
        <p><img src="<?php bloginfo( 'template_url' ); ?>/images/mobile_icon_map_home.png" /> Albergastraat 29
        </p>
        <p><img src="<?php bloginfo( 'template_url' ); ?>/images/mobile_icon_blank.png" /> Paramaribo</p>
        <p> <img src="<?php bloginfo( 'template_url' ); ?>/images/mobile_icon_blank.png" />&nbsp;Suriname</p>
        ...
        <p><img src="<?php bloginfo( 'template_url' ); ?>/images/mobile_icon.png" /> +597 8508042 | +597 8696106
        </p>
