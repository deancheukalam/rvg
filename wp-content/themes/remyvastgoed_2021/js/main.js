...
jQuery(document).ready(function () {
    ...
    jQuery("p.mailpoet_paragraph input[type='email']").attr("placeholder", "E-mail");
    jQuery("p.mailpoet_paragraph input[type='text']").attr("placeholder", "Naam");
    ...
    $('body.page-id-20495 .your-subject input').attr('value', 'Taxatie');
    $('body.page-id-20827 .your-subject input').attr('value', 'Particuliere financiering');
    $('body.page-id-6660 .your-subject input').attr('value', 'Verkoopbemiddeling');
    $('body.page-id-6749 .your-subject input').attr('value', 'Verhuurbemiddeling');
    $('body.page-id-20523 .your-subject input').attr('value', 'Aankoopbemiddeling');
    $('body.page-id-24895 .your-subject input').attr('value', 'Verkoopadvertentie plaatsen');
    $('body.page-id-24897 .your-subject input').attr('value', 'Verhuuradvertentie plaatsen');
    $('body.page-id-58066 .your-subject input').attr('value', 'PerceelsID');
    $('body.page-id-58152 .your-subject input').attr('value', 'Luchtfotografie');
    $('body.page-id-89452 .your-subject input').attr('value', '');
...
// let displayTextResult = document.getElementsByClassName('sf-foundcount');
// if(displayTextResult[0]){
//    displayTextResult = parseInt(displayTextResult[0].textContent.replace(' results', ''));
//    if (displayTextResult > 0) {
//         $("div.entry > h2").append("<span id='search-counter'>(" + displayTextResult + ")</span>");
//     }
// }
...
$(".mob-menu-icon").click(function () {
    $('.mobmenu-left-panel').attr('style', 'z-index:99999;width: 100% !important;height:100%;background-color: transparent !important;overflow-y: auto;');
    $('.mobmenu-content').attr('style', 'z-index:999991;width: 270px !important;height:100%;background-color: #24770a;overflow-y: auto;');
