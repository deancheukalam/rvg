<?php
  ...
  function arphabet_widgets_init() {
    ...
    register_sidebar( array(
      ...
      register_sidebar( array(
        'name'          => 'Sort nieuwbouwwoningen',
        'id'            => 'sort_filter_nieuwbouwwoningen',
        'before_widget' => '<div id="%1$s" class="sort_filter %2$s">',
        'after_widget'  => '</div>',
        'before_title'  => '<p class="rounded">',
        'after_title'   => '</p>',
    ...
    register_sidebar( array(
      'name'          => 'Sort Nog af te bouwen',
      'id'            => 'sort_filter_nog_af_te_bouwen',
      'before_widget' => '<div id="%1$s" class="sort_filter %2$s">',
      'after_widget'  => '</div>',
      'before_title'  => '<p class="rounded">',
      'after_title'   => '</p>',
  ...
  register_sidebar( array(
    ...
    'id'            => 'sort_filter_gated_community_woningen',
    'before_widget' => '<div id="%1$s" class="sort_filter %2$s">',
    'after_widget'  => '</div>',
    'before_title'  => '<p class="rounded">',
    'after_title'   => '</p>',
...
register_sidebar( array(
  'name'          => 'Sort Beleggings Panden',
  'id'            => 'sort_filter_beleggings-panden',
  'before_widget' => '<div id="%1$s" class="sort_filter %2$s">',
  'after_widget'  => '</div>',
  'before_title'  => '<p class="rounded">',
  'after_title'   => '</p>',
    ...
    register_sidebar( array(
      ...
      register_sidebar( array(
        ...
        'id'            => 'sort_filter_gated_community_percelen',
        'before_widget' => '<div id="%1$s" class="sort_filter %2$s">',
        'after_widget'  => '</div>',
        'before_title'  => '<p class="rounded">',
        'after_title'   => '</p>',
    ...
    register_sidebar( array(
        'name'          => 'Mobile search',
        'id'            => 'mobilesearch',
        'before_widget' => '<div id="mobilesearch"><div id="close_search"></div>',
        'after_widget'  => '</div>',
        'before_title'  => '',
        'after_title'   => '',
    ) );
...
//============================= display current file Inuse
// function displayCurrentFileInuse() {
//   global $template;
//   echo '<div style="position:absolute;margin-top:-500px;background-color:red;color:#fff;">'.$template.'</div>';
// }
// add_action( 'wp_footer', 'displayCurrentFileInuse' );
