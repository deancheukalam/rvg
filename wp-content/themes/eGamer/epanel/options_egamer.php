...
function custom_colors_css(){
	...
	<style type="text/css">
		#container { color: #<?php echo(get_option($shortname.'_color_mainfont')); ?> !important; }
		a:link, a:visited { color: #<?php echo(get_option($shortname.'_color_mainlink')); ?> !important; }
		#pages li a, .current_page_item a, .home-link a { color: #<?php echo(get_option($shortname.'_color_pagelink')); ?> !important; }
		#pages li a:hover { color: #<?php echo(get_option($shortname.'_color_pagelink_hover')); ?>!important; }
		#categories li a { color: #<?php echo(get_option($shortname.'_color_catlink')); ?> !important; }
		#categories li a:hover { color: #<?php echo(get_option($shortname.'_color_catlink_hover')); ?>!important; }
		.post-title a, .home-post-titles a, .single-entry-titles a, .titles-featured a { color:#<?php echo(get_option($shortname.'_color_recentheadings')); ?> !important; }
		.sidebar-box h2 { color:#<?php echo(get_option($shortname.'_color_sidebar_titles')); ?> !important; }
		...
		.post-info, .post-info a { color: #<?php echo(get_option($shortname.'_color_postinfo')); ?> !important; }
	</style>
