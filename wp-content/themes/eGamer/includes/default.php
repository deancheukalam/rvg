...
<?php } else { include(TEMPLATEPATH . '/includes/rating.php'); } ?>
 ...
 <h1 class="post-title" style="margin-top: 27px; line-height: 29px; font-size: 18px; font-family: verdana,geneva; font-weight: bold; text-decoration: none; margin-left: 8px;">
                Welkom</a><img src="http://www.remyvastgoed.com/wp-content/themes/eGamer/images/streep.gif" border="0">
                </h1>
 

<IFRAME SRC="?page_id=2&content-only=1" WIDTH="617" HEIGHT="220" frameborder="0" SCROLLING="no" ALLOWTRANSPARENCY="true"> Koopwoningen, percelen, verkavelingprojecten, commercieel vastgoed, taxaties, leningen, hypotheken, bouw, beheer, investeringen, huurwoningen, vakantieaccomodaties en studentenkamers in Suriname.
</IFRAME> 

<p>&nbsp;</p>

<h1 style="margin-top: 29px; line-height: 29px; font-size: 18px; font-family: verdana,geneva; font-weight: bold; text-decoration: none; margin-left: 8px;">Een greep uit het aanbod<img src="http://www.remyvastgoed.com/wp-content/themes/eGamer/images/streep.gif" border="0">
                </h1><br>
...
//query_posts('cat=80');
query_posts("cat=80&showposts=48&paged=$paged");
