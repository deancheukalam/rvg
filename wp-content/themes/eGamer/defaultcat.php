...
<h1 class="post-title" style="margin-top: 20px; line-height: 29px; font-size: 10px; font-family: verdana,geneva; font-weight: bold; text-decoration: none;"><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php printf(__('Permanent Link to %s','eGamer'), get_the_title()) ?>">
...
<div class="home-post-wrap"> 
    ...
    <div class="post-inside" align="center"> 
        ...
        <?php echo c2c_get_custom('Type', '<center> ', '', ''); ?><br><?php echo c2c_get_custom('Locatie', '', '', ''); ?><br>
          ...
          <?php echo c2c_get_custom('Prijs', '</i><font size="3"><b>', '</b></font></center>', ''); ?>
